...
class InputData {
    ...
    public int presentationTimeInMs;

    public InputData(DataType type, byte[] data, int presentationTimeInMs) {
        this.type = type;
        this.data = data;
        ...
        try {
            switch (call.method) {
                ...
                case "appendVideoFrame": {
                    ...
                    int presentationTimeInMs = call.argument("presentationTimeInMs");
